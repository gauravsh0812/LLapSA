...
if __name__ == "__main__":
    ...
    # Getting video_clips
    audios = os.listdir("/data/shared/gauravs/llapsa/audio_transcriptions")
    structure = os.listdir("/data/shared/gauravs/llapsa/structured_texts_from_gpt")
    all_files = [f"/data/shared/gauravs/llapsa/audio_transcriptions/{a}" for a in audios if a not in structure]
