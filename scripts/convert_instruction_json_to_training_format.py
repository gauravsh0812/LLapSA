...
def parse_args():
    ...
    parser.add_argument("--local_feature_path", required=True, default="",
                        help="Path to generated CLIP feature paths to filter any missing video ids.")
...
def main():
    ...
    local_feature_path = args.local_feature_path

    clip_features_files_witout_extension = ""
    if local_feature_path:
        clip_features_files = os.listdir(local_feature_path)
        clip_features_files_witout_extension = []
